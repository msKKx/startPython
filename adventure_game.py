...
creature=random.choice(['pirate','gorgon','troll','dragon','wicked fairie'])    
...
def intro(creature,weapon):
    ...
    print_pause("Rumor has it that a " + creature + " is somewhere around here, and has been terrifying the nearby village.")
...
# Things that happen to the player in the house
    ...
    print_pause("You are about to knock when the door opens and out steps a " + creature +".\n")
    print_pause("Eep! This is the " +creature+"'s house!\n")
    print_pause("The " + creature +" attacks you!\n")
    print_pause("You feel a bit under-prepared for this, what with only having a tiny "+weapon+".\n")
...
# Things that happen to the player goes in the cave  
    ...
    print_pause ("You discard your silly old "+weapon+" and take the sword with you.")
...
#Things that happen to the player goes in the field 
    print_pause("You run back into the field. Luickly, you don't seem to have been followed.\n")
    print_pause("Enter 1 to knock on the door of the house.\n")
    print_pause("Enter 2 to peer into the cave.\n")
    print_pause(one_two)
